...
TIME_UP = 0;
PORTDbits.RD0 = 1;
if (ADCAN0 < 42){AGREGADO = 0;}
else if (ADCAN0 > 42 && ADCAN0 < 84){AGREGADO = 1;}
else if (ADCAN0 > 84 && ADCAN0 < 126){AGREGADO = 2;}
else if (ADCAN0 > 126 && ADCAN0 <168){AGREGADO = 3;}
else if (ADCAN0 > 168 && ADCAN0 <215){AGREGADO = 4;}
else {AGREGADO = 5;}
NETO_X = AGREGADO + 2;
}
if (TIME_UP > NETO_X){
