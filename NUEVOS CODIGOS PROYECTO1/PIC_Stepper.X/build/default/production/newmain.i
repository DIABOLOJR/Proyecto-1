...
void main(void) {
    ...
    while(1){
        if (PORTBbits.RB2 == 0 && PORTBbits.RB3 == 1){PORTDbits.RD4 = 0; PORTDbits.RD5 = 1;}
        if (PORTBbits.RB2 == 1 && PORTBbits.RB3 == 0){PORTDbits.RD4 = 1; PORTDbits.RD5 = 0;}
        PORTEbits.RE1 = (!PORTBbits.RB5 || !PORTBbits.RB4);
        PORTEbits.RE0 = (!PORTBbits.RB6 || !PORTBbits.RB4);
        PORTEbits.RE2 = !PORTBbits.RB7;
        if (S_ABRIR == 1){
            if (PORTBbits.RB3 == 0 && PORTBbits.RB2 == 1){
                for (int a = 0; a <= 5; a++){
                    if (PORTDbits.RD7){
                        PORTDbits.RD7 = 0;
                        PORTDbits.RD6 = 1;}
                        ...
                        PORTDbits.RD7 = 1;
                        PORTDbits.RD6 = 0;}
                    _delay((unsigned long)((LEDS)*(8000000/4000.0)));}
                PORTDbits.RD7 = 0;
                PORTDbits.RD6 = 0;}
                ...
                while(PORTBbits.RB3 == 1){
                    ...
                    for (int i = 0; i < 4 ;i++){
                        if (i == 0){
                            ...
                            PORTDbits.RD2 = 0;
                            PORTDbits.RD3 = 0;
                            _delay((unsigned long)((delay)*(8000000/4000.0)));}
                        else if (i == 1){
                            PORTDbits.RD0 = 0;
                            PORTDbits.RD1 = 1;
                            PORTDbits.RD2 = 0;
